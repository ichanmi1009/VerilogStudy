...
always @(*)begin
    ...
    init:begin
        ...
        if(sw[1]==1'b1 && sw[2]==1'b0) begin
            next_state=watch_run;
        end
        else if(sw[1]==0) begin
            next_state=stopwatch_run;
        end else begin
            next_state = current_state;
        end
    end
    ...
    watch_hour : begin
        if(sw[1]==1'b0) begin
            ...
            next_state= watch_sec_1;
        end

        else if(btnR==1) begin
            next_state= min_sec_10;
...
always @(*) begin
    case(current_state)
        stopwatch_stop: o_runstop=1'b0, o_clear=1'b0, o_mode=mode_reg;
        stopwatch_run:  o_runstop=1'b1, o_clear=1'b0, o_mode=mode_reg;
        stopwatch_clear: o_runstop=1'b0, o_clear=1'b1, o_mode=mode_reg;
        stopwatch_mode: o_runstop=1'b0, o_clear=1'b0, o_mode=mode_reg;
        default: o_runstop=1'b0, o_clear=1'b0, o_mode=1'b0;
    endcase
end
