...
module fnd_controller #(
    ...
    input                    clk,
    input                    rst,
    input                    sw,       // sw[0] : 0 msec, sec / 1 min,hour
    ...
    decoder_2x4 U_DECODER_2x4 (
        .decoder_in(w_digit_sel[1:0]),  // 2비트
        .fnd_com(fnd_com)
    );
...
module counter_8 (
    ...
    always @(posedge clk, posedge rst) begin //clk 신호의 상승엣지가 발생할때마다 begin end 구현
        if (rst) begin
